...
<form method="post" action="">
    <h5 style="color: ghostwhite;">Kayıt<h5><br>
    <input type="text" name="name" placeholder="isim" required="">
    <input type="password" name="password" placeholder="şifre" required="">
    <button type="submit" name="submit" style="background-color: skyblue;"> KAYIT OL </button>
    <p class="message"> Hesabınız var mı? <a href="about.php" style="color: #E9E954;"><u> Giriş Yap </u></a> </p><br><br><br><br><br>
...
if(isset($_POST["submit"])){
  ...
  $res=mysqli_query($link, "SELECT * FROM user1 WHERE name ='$name'");
  ...
  mysqli_query($link, " INSERT INTO user1 VALUES('$name', '$password') ");

    echo '<script>
      confirm("USER REGISTERED! PLEASE LOG IN");
    </script>';
